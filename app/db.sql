...
INSERT INTO `services` (`id`, `name`, `description`, `created_at`, `updated_at`) VALUES
 (NULL, 'Pills', 'Vidonge vya majira', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(NULL, 'Implants', 'Vipandikizi/vijiti)', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);

INSERT INTO `services` (`id`, `name`, `description`, `created_at`, `updated_at`)
VALUES (NULL, 'Condoms', 'Condomu', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
 (NULL, 'Injectable', 'Sindano za Majira', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
