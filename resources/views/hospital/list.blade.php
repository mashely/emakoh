                        ...
                        <div class="tab-content">
                            <div class="tab-pane fade show active" id="pills-gen-info" role="tabpanel" aria-labelledby="pills-gen-info-tab">
                                <div>
                                    ...
                                    <div class="mb-3">
                                        <label class="form-label" for="hospital">Hospital Contact <span id="required-field">*</span> </label>
                                        <input type="number" class="form-control" name="hospital_contact"  placeholder="Enter Hospital LandLine/Phone Number">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label" for="hospital">Hospital Email Address</label>
                                        <input type="email" class="form-control" name="hospital_email"  placeholder="Enter Hospital Email Address">
                                    </div>
