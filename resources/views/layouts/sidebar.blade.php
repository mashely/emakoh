    ...
    <div id="scrollbar">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav" id="navbar-nav">
                <li class="menu-title"><span data-key="t-menu">{{ __('app.dashboard') }}</span></li>
                @if (Auth::user()->hasRole(1))
                <li class="nav-item">
                    <a class="nav-link menu-link" href="{{ url('dashboard')}}">
                        <i class="bx bx-home"></i> <span data-key="t-landing">{{ __('app.home') }}</span>
                    </a>
                </li>
                ...
                @endif
                <li class="menu-title"><span data-key="t-menu">{{ __('app.clients') }}</span></li>
                <li class="nav-item">
                    <a class="nav-link menu-link" href="{{ route('clients.list')}}">
                        <i class="bx bxs-user-detail"></i> <span data-key="t-landing">{{ __('app.clients') }}</span>
                    </a>
                </li>

                <li class="menu-title"><span data-key="t-menu">{{ __('app.reminders') }}</span></li>
                <li class="nav-item">
                    <a class="nav-link menu-link" href="{{ route('appointments.list')}}">
                        <i class="bx bx-list-ol"></i> <span data-key="t-landing">{{ __('app.reminders') }}</span>
                        @if (todayReminders() > 0)
                ...
                @if (Auth::user()->hasRole(1))
                <li class="menu-title"><span data-key="t-menu">{{ __('app.management') }}</span></li>
                <li class="nav-item">
                    <a class="nav-link menu-link" href="{{ route('hospitals.list')}}">
                        <i class="bx bx-list-ol"></i> <span data-key="t-landing">{{ __('app.hospitals') }}</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link menu-link" href="{{ route('users.list')}}">
                        <i class="bx bx-user"></i> <span data-key="t-landing">{{ __('app.users') }}</span>
                    </a>
                </li>
                <li class="nav-item">
                ...
                @endif
                @if (Auth::user()->hasRole(1))
                <li class="menu-title"><span data-key="t-menu">{{ __('app.reports') }}</span></li>
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarMaps" data-bs-toggle="collapse" role="button"
                        aria-expanded="false" aria-controls="sidebarMaps">
                        <i class="las la-envelope"></i> <span data-key="t-maps">{{ __('app.general_report') }}</span>
                    </a>
