...
var chartDatalabelsBarColors = getChartColorsArray("custom_datalabels_bar"),
    options = {
        ...
        yaxis: { labels: { show: !1 } },
        title: { text: "Custom DataLabels", align: "center", floating: !0, style: { fontWeight: 500 } },
...
var chartNegativeBarColors = getChartColorsArray("negative_bars"),
    options = {
        ...
        yaxis: { min: -5, max: 5, title: { text: "Age", style: { fontWeight: 500 } } },
        tooltip: {
            shared: !1,
            x: {
                formatter: function (t) {
        ...
        title: { text: "Mauritius population pyramid 2011", style: { fontWeight: 500 } },
        xaxis: {
...
var chartBarMarkersColors = getChartColorsArray("bar_markers"),
    options = {
        ...
        legend: { show: !0, showForSingleSeries: !0, customLegendItems: ["Actual", "Expected"], markers: { fillColors: chartBarMarkersColors } },
    };
...
options = {
    ...
    grid: { position: "back" },
    title: { text: "Paths filled by clipped image", align: "right", offsetY: 30, style: { fontWeight: 500 } },
